...
<head>
    ...
    <title>ATP - @yield('title')</title>
    <link rel="shortcut icon" type="image/png" href="../assets/images/logos/favicon.png" />
    <link rel="stylesheet" href="../assets/css/styles.min.css" />
    <link rel="stylesheet" href="../assets/libs/jquery/dist/jquery.datatables.min.css" />
    @stack('styles')
    <script>
        var appUrl = "{{ url('/') }}";
    </script>
...
<body>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item active">
                            <a class="sidebar-link" href="{{ url('/atp') }}" aria-expanded="false">
                                <span>
    ...
    <script src="../assets/libs/jquery/dist/jquery.datatables.min.js"></script>
