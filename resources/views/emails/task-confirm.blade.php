                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 130%;"><span
                                                                        ...
                                                                        ini kami sampaikan konfirmasi ATP (Confirmation
                                                                        ATP),
                                                                        berikut :</span></p>
                                                            </div>
                                                        </td>
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 10px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                            <div
                                                                style="font-size: 14px; color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong>Site Name: </strong> <span
                                                                        style="color: #828080; font-size: 14px; line-height: 19.6px;">{{ $task->site_name }}</span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 10px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                            <div
                                                                style="font-size: 14px; color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong>Site ID: </strong> <span
                                                                        style="color: #828080; font-size: 14px; line-height: 19.6px;">{{ $task->site_id }}</span>
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong>Tanggal : </strong> <span
                                                                        style="color: #828080; font-size: 14px; line-height: 19.6px;">{{ date_format(date_create($task->atp_date), 'l, d F Y') }}</span>
                                                                </p>
                                                            </div>
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 25px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                            <div
                                                                style="font-size: 14px; color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong>Alamat :  </strong><span
                                                                        style="color: #828080; font-size: 14px; line-height: 19.6px;">Dusun
                                                                        Bumi Sragi RT.001 Dusun V, Desa Pulau Jaya,
