...
Route::get('/onsite-atp/{id}', [MainController::class, 'onsiteAtp'])->middleware('auth');
Route::get('/confirm-atp/{id}/{date}', [MainController::class, 'confirmAtp'])->middleware('auth');
Route::get('/rectify-atp/{id}/{note}', [MainController::class, 'rectifyAtp'])->middleware('auth');
Route::get('/system-atp/{id}', [MainController::class, 'systemAtp'])->middleware('auth');
Route::get('/done-atp/{id}', [MainController::class, 'doneAtp'])->middleware('auth');
